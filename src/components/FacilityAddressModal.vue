...
export default defineComponent({
  ...
  methods: {
    ...
    isTelecomNumberUpdated() {
      return this.telecomNumberValue.contactNumber && this.telecomNumberValue.contactNumber && JSON.stringify(this.telecomNumberValue) !== JSON.stringify(this.telecomNumber)
    }
  },
  setup() {
